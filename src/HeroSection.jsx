...
function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="bg- text-orange-500  py-20  h-screen flex w-full items-start justify-center flex-col  bg-[url('C:\Users\DELL\Desktop\NORBERT\projekty\Ekosound-Akustyka\public\bg-waves.jpg')] bg-cover"
    >
